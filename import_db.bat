...
"C:\Program Files\MySQL\MySQL Server 8.0\bin\mysql.exe" -u root -p1234 HRM_System --default-character-set=utf8mb4 < "database\migration_fix_user21_remove_user27.sql"
echo migration_fix_user21_remove_user27.sql: %errorlevel%
