...
/**
 * ShiftAssignmentService — Scheduling coordinator interface.
 * Handles assigning shifts to employees and resolving clock-in ambiguity.
 */
public interface ShiftAssignmentService {
    ...
    /**
     * Build a weekly schedule matrix for the dashboard.
     * Returns a map: userId → (Map of dayOfWeek-index → ShiftAssignment).
     * The outer map is keyed by userId; inner map has 7 entries (Mon=0..Sun=6).
     *
     ...
     *
     * Scenario: At 13:55, Factory Shift 1 ends (14:00) and Shift 2 starts (14:00).
     * When a card swipe occurs, this method checks the user's assignment for the
     * given date to determine the correct interpretation.
     *
     ...
     *         "CHECK_IN"  if this is a start-of-shift-2 check-in,
     *         "UNKNOWN"   if no assignment found.
     */
