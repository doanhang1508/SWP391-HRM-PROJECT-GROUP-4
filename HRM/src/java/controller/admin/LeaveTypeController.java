...
public class LeaveTypeController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ("add".equals(action) || "edit".equals(action)) {
            ...
            if (leaveTypeDAO.isTypeNameExists(lt.getTypeName(), id)) {
                redirectWithError(request, response, "Tên loại nghỉ phép đã tồn tại.");
                return;
            }
    ...
    private LeaveType buildLeaveType(int id, String name, String description, String paidLeaveStr, String maxDaysStr) {
        ...
        if (maxDays != null && (maxDays < 0 || maxDays > 365)) {
            return null;
        }
    ...
    private void redirectWithError(HttpServletRequest request, HttpServletResponse response, String message) throws IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/admin/leave-types?error=" + encoded);
    }
}
