...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .s-blue{background:#eff6ff;color:#2b6cb0;} .s-green{background:#f0fdf4;color:#16a34a;} .s-amber{background:#fffbeb;color:#d97706;}
    ...
    <div class="page-main">
        <div class="page-topbar">
            <div class="page-topbar-left">
                ...
                <h1><i class="fas fa-file-contract" style="color:var(--blue);margin-right:10px;font-size:1.3rem;"></i>Quản Lý Loại Hợp Đồng</h1>
            </div>
        ...
        <div class="summary-grid">
            <div class="summary-card">
                ...
                <div>
                    ...
                    <div class="s-value">${fn:length(contractTypeList)}</div>
    ...
    <div class="modal-box">
        ...
        <form action="${pageContext.request.contextPath}/admin/contract-type" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="VD: Hợp đồng vô thời hạn" required>
            </div>
            <div class="form-group">
