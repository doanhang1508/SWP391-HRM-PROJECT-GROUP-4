...
<aside class="admin-sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-item">
            <!-- Dùng param.activeMenu để highlight đúng menu -->
            <a href="${pageContext.request.contextPath}/admin/dashboard" class="sidebar-link ${param.activeMenu eq 'dashboard' ? 'active' : ''}">
        ...
        <li class="sidebar-item">
            <a href="${pageContext.request.contextPath}/role?action=list" class="sidebar-link ${param.activeMenu eq 'roles' ? 'active' : ''}">
                <i class="fas fa-user-shield"></i> Quản lý Vai trò
            </a>
        </li>
        <li class="sidebar-item">
            <a href="${pageContext.request.contextPath}/editRolePermission" class="sidebar-link ${param.activeMenu eq 'permissions' ? 'active' : ''}">
