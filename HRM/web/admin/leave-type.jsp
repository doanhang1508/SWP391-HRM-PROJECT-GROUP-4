    ...
    <div class="dash-main">
        <div class="dash-content">
            ...
            <c:if test="${not empty error}">
                <div style="padding:15px;border-radius:8px;background:#fee2e2;color:#991b1b;border:1px solid #f87171;margin-bottom:20px;font-size:0.9rem;font-weight:500;">
                    ...
                    <tbody>
                        <c:forEach var="type" items="${leaveTypes}">
                            <tr>
                                ...
                                <td>
                                    <c:if test="${type.paidLeave == 1}">
                                        <span class="badge badge-paid">Có hưởng lương</span>
                                    </c:if>
                                    <c:if test="${type.paidLeave == 0}">
