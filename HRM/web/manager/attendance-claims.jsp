...
<c:set var="pageTitle" value="Giải Quyết Khiếu Nại Chấm Công - Enterprise HRM" scope="request" />
...
<div class="dashboard-wrapper">
    <jsp:include page="../shared/sidebar.jsp">
        <jsp:param name="activeMenu" value="attendance-claims"/>
    </jsp:include>
    ...
    <div class="main-content">
        <div style="margin-bottom:24px">
            ...
            <div class="breadcrumb-c">
                <a href="${pageContext.request.contextPath}/hr/dashboard">Dashboard</a> / Khiếu nại chấm công
            </div>
        </div>
