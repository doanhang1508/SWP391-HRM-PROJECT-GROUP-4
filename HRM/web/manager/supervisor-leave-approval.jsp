                ...
                <div class="dashboard-wrapper">
                            ...
                            <div class="dash-content">
                                ...
                                <%-- Page Header --%>
                                    ...
                                    <%-- Scope info banner — cho biết đang xem phạm vi nào --%>
                                        <c:choose>
                                            <c:when
                                                test="${sessionScope.currentUser.roleId == 3 || sessionScope.currentUser.roleId == 6}">
                    ...
                    <script>
                        ...
                        function openLeaveDetail(id, name, type, startDate, endDate, totalDays, reason, status, attachment, rejectReason) {
                            ...
                            // Status Badge
                            let statusHtml = '';
                            if (status === 'Approved') statusHtml = '<span class="badge" style="background:#dcfce7;color:#166534;">Đã duyệt</span>';
                            else if (status === 'Rejected') statusHtml = '<span class="badge" style="background:#fee2e2;color:#991b1b;">Từ chối</span>';
                            else statusHtml = '<span class="badge" style="background:#fef9c3;color:#854d0e;">Chờ duyệt</span>';
