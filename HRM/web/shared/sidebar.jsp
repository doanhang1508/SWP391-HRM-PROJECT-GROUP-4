...
<style>
    ...
    .sidebar-brand-text { font-size: 1.05rem; font-weight: 800; color: #fff; letter-spacing: -0.3px; }
    .sidebar-brand-sub  { font-size: 0.7rem; color: #64748b; font-weight: 500; margin-top: 1px; }
    ...
    .sidebar-user-name { font-size: 0.88rem; font-weight: 700; color: #f1f5f9; line-height: 1.2; }
    .sidebar-user-role { font-size: 0.72rem; color: #64748b; font-weight: 500; margin-top: 2px; }
    ...
    .sidebar-link {
        ...
        padding: 10px 12px; color: #94a3b8; text-decoration: none;
        font-weight: 500; font-size: 0.88rem;
        transition: all 0.2s ease; border-radius: 8px; gap: 10px;
    }
    .sidebar-link i { width: 20px; font-size: 0.95rem; color: #475569; transition: color 0.2s ease; text-align: center; flex-shrink: 0; }
    .sidebar-link:hover { background: rgba(255,255,255,0.06); color: #e2e8f0; }
    .sidebar-link:hover i { color: #94a3b8; }
    .sidebar-link.active { background: #0d9488; color: #fff; box-shadow: 0 2px 8px rgba(13,148,136,0.35); }
    ...
    .sidebar-logout {
        display: flex; align-items: center;
        padding: 10px 12px; color: #f87171;
        text-decoration: none; font-weight: 600; font-size: 0.88rem;
        border-radius: 8px; gap: 10px; transition: all 0.2s ease;
    }
    .sidebar-logout i { width: 20px; text-align: center; color: #f87171; flex-shrink: 0; }
    .sidebar-logout:hover { background: rgba(248,113,113,0.12); color: #fca5a5; }
    .sidebar-logout:hover i { color: #fca5a5; }

    /* ─── MOBILE ──────────────────────────────────────────── */
    .sidebar-toggle-btn {
        display: none; position: fixed; top: 72px; left: 16px; z-index: 1050;
    ...
    .sidebar-close-btn {
        ...
        font-size: 16px; color: #94a3b8; cursor: pointer; padding: 6px 8px; border-radius: 6px;
    }
    ...
    @media (max-width: 768px) {
        ...
        .main-content { width: 100% !important; padding: 20px 16px !important; }
    }
</style>
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            ...
            <c:if test="${sessionScope.currentUser.roleId == 4}">
                <li class="sidebar-menu-category">Báo cáo &amp; Tổng quan</li>
                <li class="sidebar-item">
                    <a href="${pageContext.request.contextPath}/admin/department"
                       class="sidebar-link ${param.activeMenu eq 'department' ? 'active' : ''}">
                        <i class="fas fa-building"></i> Phòng ban
