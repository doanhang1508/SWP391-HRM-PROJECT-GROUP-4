...
<%
    request.setAttribute("pageTitle", "Nội quy & Quy định Công ty");
%>
...
<style>
    ...
    .rules-card:hover { box-shadow: 0 6px 24px rgba(10,37,64,.1); }
    .rules-card-header {
    ...
    .rule-text { font-size: .9rem; color: #2d3748; line-height: 1.65; }
    .rule-text strong { color: #0a2540; }
    .toc-card {
        background: #f8fafc;
        border: 1px solid #e2e8f0;
        border-radius: 12px;
    ...
    .toc-link:hover { background: #e2e8f0; color: #0a2540; }
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            <div class="toc-card">
                ...
                <p style="font-size:.78rem;color:#94a3b8;line-height:1.5;margin:0">
                    Cập nhật lần cuối:<br>
                    <strong style="color:#4a5568">15/12/2024</strong>
                </p>
            </div>
        </div>
        ...
        <div class="col-lg-9">
            ...
            <!-- Footer note -->
            <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:12px;padding:20px 24px;display:flex;gap:16px;align-items:flex-start">
                <i class="fas fa-file-signature" style="color:#63b3ed;font-size:1.3rem;margin-top:2px"></i>
                <div>
                    <div style="font-weight:700;color:#0a2540;margin-bottom:6px">Cam kết thực hiện</div>
                    <p style="font-size:.875rem;color:#4a5568;margin:0;line-height:1.7">
