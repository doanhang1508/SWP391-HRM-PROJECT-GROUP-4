...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .item-desc { color: var(--muted); font-size: .82rem; max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
    ...
    /* ADD BUTTON */
    .btn-primary { background: var(--blue); color: #fff; border: none; padding: 10px 20px; border-radius: 8px; font-weight: 600; font-size: .875rem; cursor: pointer; display: flex; align-items: center; gap: 8px; transition: background .2s, transform .2s; font-family: 'Inter', sans-serif; text-decoration: none; }
    ...
    <main class="page-main">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card">
                ...
                <div>
                    <div class="s-label">Nhân Viên Hưởng</div>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            <button class="action-btn btn-edit"
                                                    onclick="openEditModal(${a.allowanceId}, '${fn:escapeXml(a.allowanceName)}', '${fn:escapeXml(a.description)}')"
                                                    title="Chỉnh sửa">
                                                <i class="fas fa-pen"></i>
                                            </button>
                                            <button class="action-btn btn-delete"
                                                    onclick="openDeleteModal(${a.allowanceId}, '${fn:escapeXml(a.allowanceName)}')"
                                                    title="Xóa">
    ...
    <div class="modal-box">
        ...
        <form method="post" action="${pageContext.request.contextPath}/hr/allowance">
            ...
            <div class="form-group">
                ...
                <input type="text" name="allowanceName" class="form-control" placeholder="Ví dụ: Phụ cấp ăn trưa" required maxlength="100">
            </div>
            <div class="form-group">
                <label class="form-label">Mô Tả</label>
                <textarea name="description" class="form-control" placeholder="Nhập mô tả chi tiết về loại phụ cấp này..."></textarea>
            </div>
...
<div class="modal-overlay" id="deleteModal">
    <div class="modal-box delete-modal-box">
        ...
        <div class="delete-modal-body">Bạn có chắc muốn xóa phụ cấp <strong id="deleteAllowanceName"></strong>?<br>Hành động này không thể hoàn tác.</div>
...
<script>
    ...
    function openDeleteModal(id, name) {
        ...
        document.getElementById('deleteAllowanceName').textContent = name;
