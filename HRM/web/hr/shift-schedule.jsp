...
<div class="dashboard-wrapper">
    <jsp:include page="../shared/sidebar.jsp">
        <jsp:param name="activeMenu" value="hr-shift-schedule"/>
    </jsp:include>
    ...
    <div class="main-content">
        ...
        <%-- Week Navigation --%>
        <div class="week-nav">
            <a href="${pageContext.request.contextPath}/hr/shift-schedule?week=<%= prevWeek %>">
                <i class="fas fa-chevron-left"></i> Tuần trước
            </a>
            <span class="week-label">
                <i class="fas fa-calendar-week" style="color:#6366f1;margin-right:4px;"></i>
                <%= weekDates[0].format(fullFmt) %> — <%= weekDates[6].format(fullFmt) %>
            </span>
            <a href="${pageContext.request.contextPath}/hr/shift-schedule?week=<%= nextWeek %>">
                Tuần sau <i class="fas fa-chevron-right"></i>
            </a>
            <a href="${pageContext.request.contextPath}/hr/shift-schedule" class="today-btn">
            ...
            <div class="sched-wrap">
                <table class="sched-tbl">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="emp-name">
                                <i class="fas fa-user-tie" style="color:#6366f1;margin-right:6px;"></i>
                                <%= w.getFullName() %>
                            </td>
                            <% for (int d = 0; d < 7; d++) {
                                boolean isToday = weekDates[d].equals(today);
