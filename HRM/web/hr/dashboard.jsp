        ...
        <div class="dc">
            ...
            <c:if test="${currentUser.roleId == 2}">
                <div class="stat-grid">
                    ...
                    <div class="stat-card c-teal" onclick="window.location.href = '${pageContext.request.contextPath}/hr/shift-schedule'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Xếp Lịch Ca</span><div class="sc-icon"><i class="fas fa-calendar-alt"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Lịch Ca</div>
                        <div class="sc-sub">Click để xếp ca</div>
                    </div>
                    <div class="stat-card c-green" onclick="window.location.href = '${pageContext.request.contextPath}/manager/leave'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Duyệt Nghỉ Phép</span><div class="sc-icon"><i class="fas fa-calendar-check"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Nghỉ Phép</div>
                        <div class="sc-sub">Click để duyệt</div>
                    </div>
                    <div class="stat-card c-orange" onclick="window.location.href = '${pageContext.request.contextPath}/hr/resolve-claim'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Khiếu Nại Công</span><div class="sc-icon"><i class="fas fa-balance-scale"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Khiếu Nại</div>
                        <div class="sc-sub">Click để giải quyết</div>
                    </div>
                </div>
                <div class="chart-row">
                    <div class="card">
            ...
            <c:if test="${currentUser.roleId == 5}">
                ...
                <%-- ── STAT CARDS ROW 1b: Cá nhân (HR Staff cũng là nhân viên) ── --%>
                <div style="display:flex; align-items:center; gap:10px; margin-top:10px;">
                    <span style="font-size:0.8rem; font-weight:700; color:#64748b; text-transform:uppercase; letter-spacing:0.5px; white-space:nowrap;">
                        <i class="fas fa-user" style="color:#0d9488;"></i> Cá nhân
                    </span>
                    <div style="flex:1; height:1px; background:linear-gradient(90deg,#e2e8f0,transparent);"></div>
                </div>
                <div class="stat-grid" style="margin-top:0;">
                    <div class="stat-card c-teal" onclick="window.location.href = '${pageContext.request.contextPath}/employee/work-history'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Lịch Sử Làm Việc</span><div class="sc-icon"><i class="fas fa-history"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Lịch Sử</div>
                        <div class="sc-sub">Click để xem</div>
                    </div>
                    <div class="stat-card c-green" onclick="window.location.href = '${pageContext.request.contextPath}/employee/leave'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Nghỉ Phép Của Tôi</span><div class="sc-icon"><i class="fas fa-calendar-times"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Nghỉ Phép</div>
                        <div class="sc-sub">Click để xin nghỉ</div>
                    </div>
                    <div class="stat-card c-red" onclick="window.location.href = '${pageContext.request.contextPath}/employee/resignation'" style="cursor:pointer;">
                        <div class="sc-head"><span class="sc-title">Xin Nghỉ Việc</span><div class="sc-icon"><i class="fas fa-door-open"></i></div></div>
                        <div class="sc-val" style="font-size:1.1rem; padding-top:4px;">Nghỉ Việc</div>
                        <div class="sc-sub">Click để nộp đơn</div>
                    </div>
                </div>
                    ...
                    scales: {
                        ...
                        y: {
                            ...
                            ticks: {
                                ...
                                callback: val => {
                                    if (val >= 1e9)
                                        return (val / 1e9).toFixed(1) + 'B'; // Billions (Tỷ)
                                    if (val >= 1e6)
                                        return (val / 1e6).toFixed(0) + 'M'; // Millions (Triệu)
                                    return val;
                                }
                            },
