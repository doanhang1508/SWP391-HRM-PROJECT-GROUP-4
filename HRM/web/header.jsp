            ...
            <div class="container">
                ...
                <ul class="nav-links">
                    <li><a href="${pageContext.request.contextPath}/home">Trang chủ</a></li>
                        ...
                        <li><a href="${pageContext.request.contextPath}/attendance">Chấm công</a></li>
                        <li><a href="${pageContext.request.contextPath}/payroll">Phiếu lương</a></li>
                        </c:if>
                </ul>
                ...
                <div class="nav-right">
                    ...
                    <div class="hrm-notif-wrap me-2" id="hrmNotifWrap">
                        ...
                        <%-- Nút chuông --%>
                        <button class="hrm-notif-btn" id="hrmNotifBtn" title="Thông báo" aria-label="Thông báo">
                        ...
                        <div class="hrm-notif-dropdown" id="hrmNotifPanel">
                            ...
                            <div class="hrm-notif-tabs">
                                <button class="hrm-notif-tab active" data-tab="all">Tất cả</button>
                                <button class="hrm-notif-tab" data-tab="unread">Chưa đọc</button>
                                <button class="hrm-notif-tab" data-tab="system">Hệ thống</button>
                            </div>
                    ...
                    <c:choose>
                        <c:when test="${sessionScope.currentUser != null}">
                            <div class="dropdown">
                                <button class="btn d-flex align-items-center gap-2 p-0 border-0 bg-transparent" type="button" data-bs-toggle="dropdown">
                                    <div class="user-avatar">${sessionScope.currentUser.fullName.substring(0,1)}</div>
                                    <span style="color:rgba(255,255,255,.8);font-size:.85rem;font-weight:600">${sessionScope.currentUser.fullName}</span>
                                    <i class="fas fa-chevron-down" style="color:rgba(255,255,255,.4);font-size:.7rem"></i>
                                </button>
                                <ul class="dropdown-menu dropdown-menu-end p-2" style="min-width:220px">
                                    <li><h6 class="dropdown-header text-muted" style="font-size:.75rem;letter-spacing:1px">TÀI KHOẢN</h6></li>
                                    <li><a class="dropdown-item py-2" href="${pageContext.request.contextPath}/profile"><i class="fas fa-id-badge me-2 text-primary"></i>Hồ sơ cá nhân</a></li>
                                        <c:if test="${sessionScope.currentUser.roleId != 1}">
                                        <li><a class="dropdown-item py-2" href="${pageContext.request.contextPath}/attendance"><i class="fas fa-clock me-2 text-success"></i>Lịch sử chấm công</a></li>
                                        <li><a class="dropdown-item py-2" href="${pageContext.request.contextPath}/payroll"><i class="fas fa-file-invoice-dollar me-2 text-warning"></i>Phiếu lương</a></li>
                                        </c:if>
                                        <c:if test="${sessionScope.currentUser.roleId == 1}">
                                        <li><hr class="dropdown-divider my-1"></li>
                                        <li><a class="dropdown-item py-2" href="${pageContext.request.contextPath}/admin/employees"><i class="fas fa-users me-2 text-info"></i>Quản lý nhân sự</a></li>
                                        </c:if>
                                    <li><hr class="dropdown-divider my-1"></li>
                        ...
                        <c:otherwise>
                            <a href="${pageContext.request.contextPath}/login" class="btn-nav-login">Đăng nhập</a>
