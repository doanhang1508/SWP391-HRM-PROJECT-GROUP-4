    ...
    <%@page import="java.sql.*, util.DBContext, util.PasswordUtil" %>
        ...
        <body>
            ...
            <table border="1">
                ...
                <% try (Connection c=DBContext.getConnection(); PreparedStatement ps=c.prepareStatement("SELECT user_id,
                    email, password, status FROM Users WHERE role_id=7")) { ResultSet rs=ps.executeQuery();
